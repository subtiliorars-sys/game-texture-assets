# Attribution — game-texture-assets
...
## Poly Haven (780 textures @ 1K)
- License: https://polyhaven.com/license
- ID list: `catalog/polyhaven-ids.txt`
- Example credit: `AssetId` from polyhaven.com (CC0).

Attribution optional; ledger kept for audit.
